...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { label: 'Receptionist Management', icon: 'pi pi-users', path: '/receptionist-management' },
    { label: 'Patient Data', icon: 'pi pi-folder', path: '/patient-data' },
    { label: 'Patient Registration', icon: 'pi pi-user-plus', path: '/patient-registration' }
  ];
  ...
  return (
    <aside className="w-72 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white flex flex-col h-[calc(100vh-4rem)] sticky top-16 shadow-2xl border-r border-white/10">
      ...
      <div className="p-4 border-t border-white/10 bg-white/5 backdrop-blur-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center shadow-lg shadow-blue-500/20">
          ...
          <button
            ...
            className="text-gray-400 hover:text-white transition-all p-2 rounded-lg hover:bg-red-500/20 hover:shadow-lg hover:shadow-red-500/10 group"
          >
